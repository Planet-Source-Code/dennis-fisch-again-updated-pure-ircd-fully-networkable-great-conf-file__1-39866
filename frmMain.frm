...
Begin VB.Form frmMain 
   ...
   Begin Linkable_IRCd.fbTrayIcon fbTrayIcon1 
      Height          =   1155
      Left            =   2040
      TabIndex        =   5
      Top             =   1500
...
Link(0).Listen
Me.Caption = "PURE - " & App.Major & "." & App.Minor & "." & App.Revision
...
fbTrayIcon1.AddTrayIcon App.Path & "\Tray.ico", "VB IRCd by Dennis Fisch!"
Started = Now
...
'Info
    ElseIf (strcmd(i) Like "INFO*") = True Then
        ...
        SendWsock Index, ":" & ServerName & " 371 " & Users(Index).Nick & " :This server was created Sun Aug 11 2002 at 21:38:12 (GMT +0100) by Dennis Fisch (dilligent@gmx.net)"
