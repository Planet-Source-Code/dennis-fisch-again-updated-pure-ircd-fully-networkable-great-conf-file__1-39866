...
GetWelcome = ":" & ServerName & " 001 " & User.Nick & " :Welcome to the Fox Wing IRC Network " & User.Nick & "!" & User.ID & vbCrLf
GetWelcome = GetWelcome & ":" & ServerName & " 002 " & User.Nick & " :Your server is " & ServerName & ", running version PURE-IRCd" & App.Major & "." & App.Minor & "." & App.Revision & vbCrLf
GetWelcome = GetWelcome & ":" & ServerName & " 003 " & User.Nick & " :This server was created Sun Aug 11 2002 at 21:38:12 GMT" & vbCrLf
GetWelcome = GetWelcome & ":" & ServerName & " 004 " & User.Nick & " " & ServerName & " PURE-IRCd Fox Dilligent (Fox Wing)" & vbCrLf
GetWelcome = GetWelcome & ":" & ServerName & " 005 " & User.Nick & " SAFELIST NICKLEN=" & Nicklen & " CHANTYPES=# CHANMODES=beI,k,l,imnpst MAXCHANNELS=" & MaxJoinChannels & " MAXBANS=1 NETWORK=FoxNet EXCEPTS=e INVEX=I CASEMAPPING=ascii TOPICLEN=" & TopicLen & " KICKLEN=" & KickLen & " CHARSET=UTF-8 :are available on this server" & vbCrLf
End Function
...
frmMain.lblClientSocket = "Clients: " & frmMain.wsock(0).LocalPort
frmMain.lblServerSocket = "Servers: " & LinkPort
